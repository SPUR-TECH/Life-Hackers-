...
## User Stories:
-----
 - As a user I would like to come to a site where I can watch videos on Life Hacks.

 - As a first time user I would like to see an eay to use site with no complications.

 - As a user I would like to sign up for up to date videos.

 - As a user I would like to watch videos about everyday tasks without adds. 
